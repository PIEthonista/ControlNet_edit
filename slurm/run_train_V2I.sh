...
#SBATCH -A MST111109
#SBATCH -J V2I_training_20231024_sd_unlocked_epoch_10_w_txtprompt
#SBATCH -p gp4d
#SBATCH -e train_V2I_training_20231024_sd_unlocked_epoch_10_w_txtprompt.txt
#SBATCH -c 4
#SBATCH --gres=gpu:1
...
# 532084 (running, epoch 10, sd unlocked, ori code, txt prompt)
