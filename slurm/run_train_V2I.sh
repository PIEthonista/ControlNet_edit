...
#SBATCH -A MST111109
#SBATCH -J V2I_training_20231024_sd_unlocked_epoch_10
#SBATCH -p gp4d
#SBATCH -e train_V2I_training_20231024_sd_unlocked_epoch_10.txt
#SBATCH -c 4
#SBATCH --gres=gpu:1
...
# 532081 (running, epoch 10, sd unlocked, ori code)
...
# --save_ckpt_dir /work/u5832291/yixian/ControlNet_edit/experiments/20231024_V2I
# --save_ckpt_filename 20231024_V2I
# --wandb_project ControlNet-edit
# --wandb_run_name V2I_training_20231024
