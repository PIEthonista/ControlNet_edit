...
#SBATCH -A MST111109
#SBATCH -J colorization_training_20231119_sd_unlocked_epoch_10_w_txt_prompt_ori
#SBATCH -p gp4d
#SBATCH -e train_colorization_training_20231119_sd_unlocked_epoch_10_w_txt_prompt_ori.txt
#SBATCH -c 4
#SBATCH --gres=gpu:1
