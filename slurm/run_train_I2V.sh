...
#SBATCH -A MST111109
#SBATCH -J I2V_training_20231024_sd_unlocked_epoch_10_w_txtprompt
#SBATCH -p gp4d
#SBATCH -e train_I2V_training_20231024_sd_unlocked_epoch_10_w_txtprompt.txt
#SBATCH -c 4
#SBATCH --gres=gpu:1
...
# 532083 (running, epoch 10, sd unlocked, ori code, txt prompt)
