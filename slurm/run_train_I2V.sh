...
#SBATCH -A MST111109
#SBATCH -J I2V_training_20232016
#SBATCH -p gp4d
#SBATCH -e train_I2V_training_20232016.txt
#SBATCH -c 4
#SBATCH --gres=gpu:1
...
# --save_ckpt_dir /work/u5832291/yixian/ControlNet_edit/experiments/20231016_I2V
# --save_ckpt_filename 20231016_I2V